...
const SEARCH_INDEX=[{"url":"/","title":"XTIANZ AI Systems Intelligence","category":"Home","summary":"Practitioner-led AI architecture, agents, MCP, Claude, infrastructure, companies and market signals.","code":"X"},{"url":"/signals.html","title":"Current AI Signals","category":"Intelligence","summary":"Dated evidence briefs separating observed facts, interpretation and what to verify next.","code":"SIG"},{"url":"/architecture.html","title":"AI Architecture Patterns","category":"Architecture","summary":"RAG, workflows, bounded agents, routing, approval gates, sandboxing, memory, failover and evaluations.","code":"ARC"},{"url":"/ai-mcp.html","title":"AI + MCP","category":"Engineering","summary":"Model Context Protocol, enterprise agents, permissions, observability and production controls.","code":"MCP"},{"url":"/claude.html","title":"Claude Desk","category":"Claude","summary":"Claude Code, secure agent tools and enterprise governance for practitioners.","code":"CL"},{"url":"/lab.html","title":"AI Engineering Lab","category":"Interactive","summary":"Architecture recommender, agent advisor, evaluation planner, MCP threat model and economics tools.","code":"LAB"},{"url":"/risk.html","title":"AI Risk Engineering","category":"Risk","summary":"Govern, map, measure and manage production AI risk and readiness.","code":"RSK"},{"url":"/mangos.html","title":"MANGOS Company Systems Map","category":"Companies","summary":"Compare Meta, Anthropic, Nvidia, Google, OpenAI and SpaceX by system role and evidence.","code":"MX"},{"url":"/markets.html","title":"AI Markets","category":"Markets","summary":"Demand, supply, infrastructure economics, capital spending and execution risk.","code":"MKT"},{"url":"/dmv.html","title":"DMV Pulse","category":"DMV","summary":"Loudoun and DMV infrastructure context plus links to original local publishers and official sources.","code":"DMV"},{"url":"/author.html","title":"Chris M. — Author and Technical Review","category":"Trust","summary":"The practitioner perspective and review method behind XTIANZ flagship guides.","code":"AUT"},{"url":"/editorial-policy.html","title":"Editorial Policy","category":"Trust","summary":"Primary-source hierarchy, AI-assistance disclosure, review metadata and corrections policy.","code":"ED"},{"url":"/articles/enterprise-ai-architecture-decision-framework.html","title":"Enterprise AI Architecture Decision Framework","category":"Architecture","summary":"Choose traditional automation, RAG, deterministic workflows or bounded agents using an original decision framework.","code":"DEC"},{"url":"/articles/ai-agent-failure-modes-controls.html","title":"AI Agent Failure Modes and Controls","category":"Reliability","summary":"Twelve realistic failure modes with prevention, detection, containment and recovery controls.","code":"FAIL"},{"url":"/articles/ai-agents-enterprise-operations.html","title":"AI Agents for Enterprise Operations","category":"Operations","summary":"Service ownership, SLOs, approvals, observability and staged autonomy for production agent systems.","code":"OPS"},{"url":"/articles/what-is-mcp-ai-agents.html","title":"MCP Architecture Guide","category":"AI + MCP","summary":"Hosts, clients, servers, transports, tools, resources and prompts using the current 2026-07-28 specification.","code":"MCP"},{"url":"/articles/mcp-security-governance-checklist.html","title":"MCP Security and Governance","category":"Security","summary":"Authorization, tool privilege, token handling, logging, prompt injection, recovery and approval controls.","code":"SEC"},{"url":"/articles/mcp-specification-status.html","title":"MCP 2026-07-28 Specification Status","category":"AI + MCP","summary":"What changed, compatibility risks and a controlled migration checklist for engineering teams.","code":"VER"},{"url":"/articles/claude-code-engineering-guide.html","title":"Claude Code for Enterprise Engineering","category":"Claude","summary":"Repository context, permissions, hooks, MCP, evaluation, rollout and production guardrails.","code":"CODE"},{"url":"/articles/claude-agents-tools-mcp.html","title":"Secure Tool Architecture for Claude Agents","category":"Claude","summary":"Per-tool policy, remote MCP, verification, side-effect controls and observability.","code":"AGT"},{"url":"/articles/claude-enterprise-governance.html","title":"Claude Enterprise Governance","category":"Claude","summary":"Identity, managed policy, data boundaries, adoption evidence and operating controls.","code":"GOV"},{"url":"/articles/ai-data-centers-power-water.html","title":"AI Infrastructure Economics","category":"Infrastructure","summary":"How compute demand becomes power, cooling, facility and geography constraints.","code":"INF"},{"url":"/articles/dmv-ai-infrastructure-corridor.html","title":"Why the DMV Matters to AI Infrastructure","category":"DMV + Infrastructure","summary":"Loudoun data centers, power, fiber, land use, economics and community impacts.","code":"LC"},{"url":"/articles/mangos-explained-ai-companies.html","title":"MANGOS Systems Map","category":"Companies","summary":"An original framework for comparing six influential AI-era companies by system role and evidence.","code":"MX"},{"url":"/articles/nvidia-ai-infrastructure-boom.html","title":"NVIDIA and the AI Infrastructure Stack","category":"Markets","summary":"GPUs, networking, software and data-center demand interpreted through primary operating evidence.","code":"NV"},{"url":"/articles/xtianz-weekly-signal-method.html","title":"The XTIANZ Signal Method","category":"Editorial","summary":"A repeatable framework to separate observed fact, interpretation and forecast across AI signals.","code":"XS"}];
...
(()=>{
  ...
  if(!links.some(a=>a.hasAttribute('aria-current'))){
    const sectionMap={
      ...
      '/articles/enterprise-ai-architecture-decision-framework.html':'/ai-mcp.html',
...
/* XTIANZ v40 interaction enhancements */
(() => {
  const tabs = [...document.querySelectorAll('.lab-tabs-v40 a')];
  if (tabs.length) {
    const panels = tabs.map(a => document.querySelector(a.getAttribute('href'))).filter(Boolean);
    const observer = new IntersectionObserver(entries => {
      const visible = entries.filter(e => e.isIntersecting).sort((a,b)=>b.intersectionRatio-a.intersectionRatio)[0];
      if (!visible) return;
      tabs.forEach(a => a.toggleAttribute('aria-current', a.getAttribute('href') === `#${visible.target.id}`));
    }, {rootMargin:'-28% 0px -58% 0px', threshold:[0,.2,.5]});
    panels.forEach(p => observer.observe(p));
  }
  document.querySelectorAll('.system-flow-v40 li').forEach((item, i) => {
    item.style.setProperty('--flow-delay', `${i * 90}ms`);
  });
})();
